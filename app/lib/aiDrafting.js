...
export const HARD_BLOCKLIST_PHRASES = [
  ...
  'that resonated', 'resonated with you', 'resonates with you', 'worked well for you',
  'that comes through', 'that came through', 'glad that comes through', 'glad that came through', // "it's wonderful
