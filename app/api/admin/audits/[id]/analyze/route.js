...
SELF-CHECK before finalizing each rewrite: Read it one more time and ask four questions: (1) "Could a reasonable person reading this determine that the reviewer IS or WAS a patient?" (2) "Does this rewrite reference a records search in ANY way — found, not found, connected, matched, or unable to locate?" (3) "Does this rewrite contain any phone number, email, or address?" (4) "Does this rewrite imply an ongoing or future care relationship — 'going forward,' 'next visit,' 'see you soon,' or similar?" If the answer to ANY of these is yes, rewrite it to remove that element entirely. When in doubt, be MORE general, not less.
