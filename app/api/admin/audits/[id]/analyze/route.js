...
Respond ONLY with valid JSON in this exact structure, no other text:
{
  ...
  "loom_talking_points": ["3-5 SHORT bullet points (under 15 words each, headline-style, NOT full sentences to read verbatim) summarizing the TOP patterns or standout issues in THIS specific audit, for a salesperson to glance at and speak from naturally during a video walkthrough — ad-lib style, not scripted. Focus on the most notable PATTERNS across findings, not a list of individual findings (those are already visible in the report). Good examples of the right style: 'More patient status confirmed in positive reviews than negative ones' / 'Missed opportunity — 16 negative reviews with zero response' / 'Same templated denial used on 3 different reviewers' / 'Worst offender: the billing dispute response, stacks 3 violations at once'. Bad examples (too long, too scripted): a full paragraph explaining the legal reasoning, or a sentence written to be read word-for-word. These bullets are FOR THE SALESPERSON ONLY — internal, never shown to the client."],
  "findings": [
    {
