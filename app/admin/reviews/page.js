    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.complianceFlag === 'blocked_needs_human_review') {
          ...
          setMsg('⚠️ Our system already tried to soften fault-conceding language here (e.g. "you\'re right" or "we should have") and couldn\'t fully fix it automatically. This one needs real human editing, not just a quick tweak — acknowledge the feeling, not the fault.')
