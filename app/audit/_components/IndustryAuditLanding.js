...
// Shared template for all /audit/[industry] landing pages. Only the pieces
// that genuinely differ per industry are passed in as props (the headline,
// and the one concrete violation example that matches that industry's real
// failure pattern) — everything else (pricing, footer, how-it-works, founder
// quote) lives here once, so a future copy or pricing change only has to
// happen in one place instead of three separately-maintained files drifting
// apart, which was a real, repeated bug source earlier today.
export default function IndustryAuditLanding({ headlineLine1, headlineLine2, badExample }) {
  return (
    <main>
        ...
        <div className="container">
          ...
          <div className="bad-examples">
            <div className="bad-card">
              <div className="bad-label bad-label-red">{badExample.label}</div>
              <div className="bad-review">
                <span className="bad-text">{badExample.text}</span>
              </div>
              <div className="bad-verdict">{badExample.verdict}</div>
            </div>
            <div className="bad-card">
        ...
        <div className="container">
          ...
          <div className="steps">
            ...
            <div className="step">
              ...
              <p>Our proprietary AI — calibrated across dental, chiropractic, physical therapy, and more — reviews every response on your profiles.</p>
            </div>
            <div className="step">
