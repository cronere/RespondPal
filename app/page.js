  ...
  const faqs = [
    {
      ...
      a: "We'll walk you through adding us as a Manager on your Google Business Profile — a standard Google feature that takes about 3 minutes. You remain the Owner at all times. If you ever cancel, you remove our access instantly.",
    },
    {
      q: 'What if I get a really negative or complicated review?',
      a: "That's exactly where we shine. Negative reviews get extra care — professional, measured responses that acknowledge the concern, protect your reputation, and invite resolution offline. We never argue, never get defensive.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes — each location is $297/month. If you have 3 or more locations, contact us for a discounted multi-location rate.",
    },
  ]
    ...
    <>
      ...
      <section className="hero">
        <div className="container">
          ...
          <h1>
            Every Google review.
            <br />
            <em>Answered in 24 hours.</em>
            <br />
            You do nothing.
          </h1>
          <p className="hero-sub">
            We respond to every Google review your business receives —
            professionally, promptly, and on-brand — so you can focus on
      ...
      <section className="problem" id="problem">
        <div className="container">
          ...
          <p className="section-sub">
            ...
            they read your reviews. If your competitor responds and you
            don&apos;t, you lose. It&apos;s that simple.
          </p>
          <div className="stat-grid">
            <div className="stat-box">
              ...
              <div className="desc">
                of consumers expect businesses to respond to their review
              </div>
            ...
            <div className="stat-box">
              ...
              <div className="desc">
                days — average time a business takes to respond (when they
                respond at all)
              </div>
            ...
            <div className="stat-box">
              ...
              <div className="desc">
                of consumers always read reviews before choosing a local business
              </div>
              <div className="stat-source">BrightLocal Local Consumer Review Survey</div>
            </div>
            <div className="stat-box">
              ...
              <div className="desc">
                more revenue correlates with businesses that respond to every
                review
              </div>
        ...
        <div className="container">
          ...
          <div className="steps">
            <div className="step">
              ...
              <h3>You sign up</h3>
              <p>
                Takes 5 minutes. You grant us manager access to your Google
                Business Profile — we walk you through the exact steps.
              </p>
            </div>
            <div className="step">
              ...
              <p>
                Every review that comes in — 5-star praise, 1-star complaint, no
                text at all — gets a professional, thoughtful response drafted by
                our team.
              </p>
            </div>
            <div className="step">
              ...
              <p>
                Within 24 hours of each review posting, a response publishes
                under your business. On-brand, on-time, every time.
              </p>
            </div>
            <div className="step">
              ...
              <p>
                Log into your dashboard anytime to see what&apos;s been posted.
      ...
      <section className="demo" id="demo">
        <div className="container">
          ...
          <p className="section-sub">
            Professional. Specific. Human. Never templated.
          </p>
          <div className="demo-card">
            <div className="review-item">
              <div className="review-meta">
                ...
                <div>
                  <div className="reviewer-name">Sarah R.</div>
                  <div className="stars">★★★★★</div>
                </div>
              </div>
              <div className="review-text">
                &ldquo;Absolutely love this place. Best service I&apos;ve had in
                years. Will definitely be back and telling all my friends!&rdquo;
              </div>
              <div className="response-box">
                <div className="response-label">
                  Owner response · posted within 24 hrs
                </div>
                <div className="response-text">
                  Thank you so much, Sarah — this genuinely made our day!
                  We&apos;ll make sure to pass along the kind words to the team.
            ...
            <div className="review-item">
              <div className="review-meta">
                ...
                <div>
                  <div className="reviewer-name">Tom K.</div>
                  <div className="stars low">★★☆☆☆</div>
                </div>
              </div>
              <div className="review-text">
                &ldquo;Service was slow and nobody checked in on us. The food
                itself was good but the experience was frustrating.&rdquo;
              </div>
              <div className="response-box">
                <div className="response-label">
                  Owner response · posted within 24 hrs
                ...
                <div className="response-text">
                  ...
                  down on the service side. That&apos;s not the experience we
                  work hard to deliver, and we hear you. Please reach out
                  directly and we&apos;ll make it right on your next visit.
                </div>
              </div>
            </div>
            <div className="demo-note">
              <div className="dot" />
              All responses posted directly from your Google Business Profile
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="feat-grid">
            ...
            <div className="feat">
              ...
              <p>
                Our team reviews every response before it goes live. No generic
                copy-paste — written for your business and your reviewer.
              </p>
            </div>
            <div className="feat">
              <div className="feat-icon">⭐</div>
              <h3>All star ratings covered</h3>
              <p>5-star, 1-star, no-text reviews. We respond to them all.</p>
            </div>
            <div className="feat">
              <div className="feat-icon">📊</div>
              <h3>Client dashboard</h3>
              <p>
                See every review and every response in one clean place. Full
                transparency, zero effort.
              </p>
            </div>
            <div className="feat">
              <div className="feat-icon">🔒</div>
              ...
              <p>
                We use Google&apos;s official manager access — you stay the owner.
                Cancel anytime and access is immediately revoked.
              </p>
            </div>
            <div className="feat">
              <div className="feat-icon">📍</div>
              ...
              <p>
                Restaurant, dental office, law firm, HVAC company — if you have
                a Google Business Profile, we can manage it.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="compare-grid">
            <div className="compare-col bad">
              ...
              <ul className="clist">
                <li>Reviews pile up unanswered for weeks</li>
                ...
                <li>You feel it every time you open Google Maps</li>
              </ul>
            </div>
            <div className="compare-col good">
              ...
              <ul className="clist">
                ...
                <li>Negative reviews handled with care</li>
        ...
        <div className="container">
          ...
          <div className="price-card">
            ...
            <div className="price-note">
              Setup takes less than 10 minutes. You&apos;ll be live within 48
              hours.
            </div>
          </div>
          <p className="multi-note">
            Manage multiple locations?{' '}
            <a href="mailto:hello@respondpal.ai">
              Contact us for a multi-location rate.
            </a>
          </p>
        </div>
      </section>
      ...
      <section className="sources-sec">
        <div className="container sources-inner">
          ...
          <ul className="sources-list">
            <li>
              <sup>1</sup> BrightLocal Local Consumer Review Survey (2024)
            </li>
            <li>
              <sup>2</sup> Harvard Business Review — &ldquo;Responding to
              Customer Reviews&rdquo; (2022)
            </li>
            <li>
              <sup>3</sup> ReplyOnTheFly Benchmark Report (2023)
            </li>
          </ul>
        </div>
      </section>
